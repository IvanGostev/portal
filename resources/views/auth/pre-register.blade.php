        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card--text" style="padding: 20px;">
                    ...
                    <p  class="card-title">
                        Прохождение регистрации у Вас займет несколько минут. Необходимо ввести основную информацию о компании для передачи данных в ПАО «СИБУР Холдинг» ( см. инструкцию ). Для идентификации компании требуется внести ИНН, КПП в разделе " Общая информация о компании ".
