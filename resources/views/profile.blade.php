                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="country_id" class="form-control" required>
                                            @foreach($countries as $country)
                                                <option
                                                    {{auth()->user()->country_id == $country->id ? 'selected' : 0}}> {{$country->title}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                   ...
                                                   id="auth()->user()->                               <label class="form-check-label" for="exampleCheck2">Совпадает
                                                с юридическим</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="mail_country_id" class="form-control" required>
                                            @foreach($countries as $country)
                                                <option
                                                  {{auth()->user()->mail_country_id == $country->id ? 'selected' : ''}} >{{$country->title}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="mail_city_id" class="form-control" required>
                                            @foreach($cities as $city)
                                                <option
                                                    {{auth()->user()->mail_city_id == $city->id ? 'selected' : ''}}> {{$city->title}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="legal_country_id" class="form-control" required>
                                            @foreach($countries as $country)
                                                <option
                                                 {{auth()->user()->legal_country_id == $country->id ? 'selected' : ''}} > {{$country->title}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="legal_city_id" class="form-control" required>
                                            @foreach($cities as $city)
                                                <option
                                                    {{request()->session()->has('legal_city_id') ? (request()->session()->get('legal_city_id')[0] == $city->id ? 'selecteauth()"->user()->{{$city->title}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bank_country_id" class="form-control" required>
                                            @foreach($countries as $country)
                                                <option
                                                    {{auth()->user()->bank_country_id == $country->id ? 'selected' : ''}}> {{$country->title}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="currency_id" class="form-control" required>
                                            @foreach($currencies as $currency)
                                                <option
                                                    {{request()->session()->has('currency_id') ? (request()->session()->get('currency_id')[0] == $currency->id ? 'selected' :auth()->user()->{{$currency->title"}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input name="work_edo"
                                                   ...
                                                   id="eauth()->user()->                               <label class="form-check-label" for="exampleCheck2">Согласен
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    {{--                                                                <option--}}
  auth()->user()->       {{--                                                                    {{request()->session()->has('language_id') ? (request()->session()->get('language_id')[0] == $language->id ? 'selected' : '') : ''}} value="{{$languag}}
                                    {{--                                                                    {{$language->title}}--}}
                                    {{--                                                                </option>--}}
                                    {{--                                                            @endforeach--}}
                                    {{--                                                        </select>--}}
            ...
            <div class="row mb-0">
                ...
                <div class="col-md-6 offset-md-0">
                    ...
                    <bauth"()->user()->egister"}} class="btn btn-dark">
                        {{ __('Обновить') }}
                    </button>
                </div>
            </div>
